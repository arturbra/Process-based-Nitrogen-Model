...
setup_file = "Nitrogen_quality_module.ini"
...
# **2. Input variables**
from Water_flow_module import *
run_W()

cin_nh4_file = pd.read_csv('Cinflow_NH4.csv')
cin_nh4_list = cin_nh4_file['nh4'].tolist()

cin_no3_file = pd.read_csv('Cinflow_NO3.csv')
cin_no3_list = cin_no3_file['no3'].tolist()

cin_o2_file = pd.read_csv('Cinflow_O2.csv')
cin_o2_list = cin_o2_file['o2'].tolist()

cin_doc_file = pd.read_csv('Cinflow_DOC.csv')
