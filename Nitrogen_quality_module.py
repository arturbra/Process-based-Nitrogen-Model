...
def run_Kin():
    for t in range(len(WFR.indice)-1):
        ...
        if hp == 0:
            ...
            O2.cpi = PZ.f_concentration(INFLOW_PARAMETERS.cin_o2[t], WFR.tQin[t], O2.cp_a, WFR.tQpf[t], WFR.tQover[t], O2.Rx_pz, hp, hp_a, GENERAL_PARAMETERS.dt, 0.00002)
            NH4.cpi = PZ.f_concentration(INFLOW_PARAMETERS.cin_nh4[t], WFR.tQin[t], NH4.cp_a, WFR.tQpf[t], WFR.tQover[t], NH4.Rx_pz, hp, hp_a, GENERAL_PARAMETERS.dt, 0.00002)
            NO3.cpi = PZ.f_concentration(INFLOW_PARAMETERS.cin_no3[t], WFR.tQin[t], NO3.cp_a, WFR.tQpf[t], WFR.tQover[t], NO3.Rx_pz, hp, hp_a, GENERAL_PARAMETERS.dt, 0.00002)
            #DOC.cpi = PZ.f_concentration(INFLOW_PARAMETERS.cin_doc[t], WFR.tQin[t], DOC.cp_a, WFR.tQpf[t], WFR.tQover[t], DOC.Rx_pz, hp, hp_a, GENERAL_PARAMETERS.dt, 0.00002)
    ...
    #Predictive step
            ...
            for l in range(USZ.m_usz):
                ...
                O2.csi_usz.append(O2.concentration_soil_phase_usz())
                NH4.csi_usz.append(NH4.concentration_soil_phase_usz(l, t, WFR.tteta_usz[t], SOIL_PLANT.ro, GENERAL_PARAMETERS.dt, 0.00000000000001, kmicro=NH4.k_nh4_mb))
                NO3.csi_usz.append(NO3.concentration_soil_phase_usz())

                #DOC.cs = DOC.cs_usz[t][l]
                ...
                O2.Rxi_usz = O2.f_reaction_usz(O2.cli[l], NH4.cli[l], GENERAL_PARAMETERS.k_nit) + O2.f_plant_uptake_usz(O2.cli[l], SOIL_PLANT.c_o2_root, SOIL_PLANT.root_fraction, SOIL_PLANT.lamda, WFR.tteta_usz[t])
                NH4.Rxi_usz = NH4.f_reaction_usz(NH4.cli[l], GENERAL_PARAMETERS.k_nit) + NH4.f_plant_uptake_usz(NH4.cli[l], SOIL_PLANT.root_fraction, WFR.tteta_usz[t])
                NO3.Rxi_usz = NO3.f_reaction_usz(NH4.cli[l], GENERAL_PARAMETERS.k_nit) + NO3.f_plant_uptake_usz(NO3.cli[l], SOIL_PLANT.root_fraction, WFR.tteta_usz[t])
    ...
    ### Oxygen
                ...
                concentration = O2.concentration_delta_usz(t, O2.peclet_usz, l, USZ.m_usz, GENERAL_PARAMETERS.dz, WFR.tteta_usz[t], teta_sm_iplus1, USZ.unit_flux, GENERAL_PARAMETERS.dt, SOIL_PLANT.ro, SOIL_PLANT.f, 0.0000000000000001)
                O2.cl_i1.append(concentration)

    ### Amonia
                NH4.peclet_usz = USZ.f_peclet(USZ.unit_flux, NH4.D, GENERAL_PARAMETERS.dz)
                concentration = NH4.concentration_delta_usz(t, NH4.peclet_usz, l, USZ.m_usz, GENERAL_PARAMETERS.dz, WFR.tteta_usz[t], teta_sm_iplus1, USZ.unit_flux, GENERAL_PARAMETERS.dt, SOIL_PLANT.ro, SOIL_PLANT.f, 0.0000000000000001)
                NH4.cl_i1.append(concentration)

    ### Nitrate
                NO3.peclet_usz = USZ.f_peclet(USZ.unit_flux, NO3.D, GENERAL_PARAMETERS.dz)
                concentration = NO3.concentration_delta_usz(t, NO3.peclet_usz, l, USZ.m_usz, GENERAL_PARAMETERS.dz, WFR.tteta_usz[t], teta_sm_iplus1, USZ.unit_flux, GENERAL_PARAMETERS.dt, SOIL_PLANT.ro, SOIL_PLANT.f, 0.0000000000000001)
    ...
    #####   SZ   #####
        ...
        for j in range(SZ.m_sz):
            ...
            O2.csi_sz.append(O2.concentration_soil_phase_sz())
            NH4.csi_sz.append(NH4.concentration_soil_phase_sz(j, t, WFR.tteta_sz[t], SOIL_PLANT.ro, GENERAL_PARAMETERS.dt, 0.0000000000000001, kmicro=NH4.k_nh4_mb))
            NO3.csi_sz.append(NO3.concentration_soil_phase_sz())
            ...
            O2.Rxi_sz = O2.f_reaction_sz(O2.cji[j], NH4.cji[j], GENERAL_PARAMETERS.k_nit) + O2.f_plant_uptake_sz(O2.cji[j], SOIL_PLANT.c_o2_root, SOIL_PLANT.root_fraction, SOIL_PLANT.lamda, WFR.tteta_sz[t])
            NH4.Rxi_sz = NH4.f_reaction_sz() + NH4.f_plant_uptake_sz(NH4.cji[j], SOIL_PLANT.root_fraction, WFR.tteta_sz[t])
            NO3.Rxi_sz = NO3.f_reaction_sz(NO3.cji[j], GENERAL_PARAMETERS.k_denit) + NO3.f_plant_uptake_sz(NO3.cji[j], SOIL_PLANT.root_fraction, WFR.tteta_sz[t])
...
### DOC
    ...
    return data_o2, data_nh4, data_no3
    
if __name__ == '__main__':
    inicio = datetime.datetime.now()
    run_W()
    WFR.water_balance(GENERAL_PARAMETERS.dt)
    data_o2, data_nh4, data_no3 = run_Kin()
    ...
    print('Done!')
    wf_test = results_tests.water_flow_comparison_test("results/results_hpipe_0/water_flow_results.csv", WFR)
    nh4_test = results_tests.water_quality_comparison_test("results/results_hpipe_0/results_Kin_pf_nh4_2.csv", data_nh4)
    o2_test = results_tests.water_quality_comparison_test("results/results_hpipe_0/results_Kin_pf_o2.csv", data_o2)
    no3_test = results_tests.water_quality_comparison_test("results/results_hpipe_0/results_Kin_pf_no3.csv", data_no3)
