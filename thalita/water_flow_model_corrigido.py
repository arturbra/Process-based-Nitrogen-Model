...
#Rainfall file
Qrain_file = pd.read_csv('thalita/arquivos_entrada_modelo_ecoli_ev_03_21/01_Qrain_file2.csv')
tQrain = Qrain_file['Qrain'].tolist()

#Evapotranspiration file
Emax_file = pd.read_csv('thalita/arquivos_entrada_modelo_ecoli_ev_03_21/01_Emax_file2.csv')
